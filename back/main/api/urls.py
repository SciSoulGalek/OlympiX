...
from .views import OlympiadViewSet, NewsViewSet, my_olympiads, olympiad_registration_status, register_for_olympiad, user_profile_view
...
urlpatterns = [
    ...
    path('registration/olympiad/<int:olympiad_id>/status/', olympiad_registration_status, name='registration_status'),
